...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoKoMoJavascriptClient.CompetenceBaseType();
  });
  ...
  describe('CompetenceBaseType', function() {
    it('should create an instance of CompetenceBaseType', function() {
      // uncomment below and update the code to test CompetenceBaseType
      //var instance = new CoKoMoJavascriptClient.CompetenceBaseType();
      //expect(instance).to.be.a(CoKoMoJavascriptClient.CompetenceBaseType);
    });
